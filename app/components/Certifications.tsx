...
const Certifications = () => {
  ...
  const certificatesData: Certificate[] = [
    {
      ...
      issuer: 'Udemy',
      image: '/UtthamD/Screenshot 2025-04-30 103152.png',
      category: 'web',
      date: '2024',
      type: 'certificate'
    },
    {
      ...
      issuer: 'Google',
      image: '/UtthamD/Screenshot 2025-04-30 103234.png',
      category: 'networking',
      date: '2024',
      type: 'certificate'
    },
    {
      ...
      issuer: 'Coursera',
      image: '/UtthamD/Screenshot 2025-04-30 103341.png',
      category: 'web',
      date: '2024',
      type: 'certificate'
    },
    {
      ...
      type: 'achievement',
      achievementDetails: 'Secured Global Rank 13547 among 32k+ participants',
      date: 'February 2025',
      category: 'achievements'
    },
    {
      title: '64th National level Chess SGFI',
      type: 'achievement',
      achievementDetails: 'Inter-district Captain and State 4th position',
      date: '2024',
      category: 'achievements'
    },
    {
      title: '65th National level Chess SGFI',
      type: 'achievement',
      achievementDetails: 'Inter-district Captain and State 4th position',
      date: '2025',
      category: 'achievements'
  ...
  const filteredCertificates = filter === 'all' 
    ? certificatesData 
    : certificatesData.filter((cert: Certificate) => cert.category === filter);
    ...
    <section id="certifications" className="certifications" ref={sectionRef} >
      <div className="container">
        ...
        >
          ...
          <button 
            className={`cert-filter-btn ${filter === 'achievements' ? 'active' : ''}`}
          ...
          {filteredCertificates.map((cert, index) => (
            ...
            >
              ...
              <div className="cert-overlay">
                <h3>{cert.title}</h3>
                {cert.type === 'certificate' && <p>{cert.issuer}</p>}
            ...
            >
              ...
              >
                ...
                <div className="cert-modal-info">
                  ...
                  {selectedCert.type === 'certificate' && <p>Issued by: {selectedCert.issuer}</p>}
