        ...
        >
          <motion.div className="hero-text" variants={containerVariants}>
            ...
            <motion.div className="hero-buttons" variants={itemVariants}>
              ...
              <Link href="/UtthamD_Resume.pdf" target="_blank" className="btn btn-secondary">
                Download CV
              </Link>
            </motion.div>
            ...
            <motion.div className="social-icons" variants={itemVariants}>
              <motion.a 
                href="https://www.linkedin.com/in/uttham-naresh-357b20313" 
                target="_blank"
              ...
              <motion.a 
                href="https://github.com/UtthamChess333" 
                target="_blank"
                whileHover={{ y: -5, color: "#6c63ff", backgroundColor: "#fff" }}
                transition={{ type: "spring", stiffness: 500 }}
              >
